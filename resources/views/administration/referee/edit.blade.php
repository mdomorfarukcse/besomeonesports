                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="first_name" value="{{ $referee->first_name }}" class="form-control @error('first_name') is-invalid @enderror" placeholder="Joseph" required/>
                                            @error('first_name')
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="last_name" value="{{ $referee->last_name }}" class="form-control @error('last_name') is-invalid @enderror" placeholder="Kerr" required/>
                                            @error('last_name')
                                                <b class="text-danger"><i class="feather icon-info mr-1"></i>{{ $message }}</b>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="tel" name="contact_number" value="{{ $referee->contact_number }}" class="form-control @error('contact_number') is-invalid @enderror" placeholder="+1 (123) 456 -7890" required/>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" name="state" value="{{ $referee->state }}" class="form-control @error('state') is-invalid @enderror" placeholder="State" required/>
                                            @error('state')
                                                <b class="text-danger"><i class="feather icon-info mr-1"></i>{{ $message }}</b>
                                            @enderror
                                        </div>
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" name="city" value="{{ $referee->city }}" class="form-control @error('city') is-invalid @enderror" placeholder="City" required/>
                                            @error('city')
                                                <b class="text-danger"><i class="feather icon-info mr-1"></i>{{ $message }}</b>
                                            @enderror
                                        </div>
