...
@section('page_title', __('Division'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('Division') }}</b>
@endsection


@section('breadcrumb')
    <li class="breadcrumb-item text-capitalize active">{{ __('Division') }}</li>
@endsection
            ...
            <div class="card-body">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="nav-link mb-2 active" id="v-pills-dashboard-tab" data-toggle="pill" href="#v-pills-dashboard" role="tab" aria-controls="v-pills-dashboard" aria-selected="true">
                        <i class="feather icon-grid mr-2"></i>Dashboard
                    </a>
                    ...
                    <a class="nav-link mb-2" id="v-pills-addresses-tab" data-toggle="pill" href="#v-pills-addresses" role="tab" aria-controls="v-pills-addresses" aria-selected="false">
                        <i class="feather icon-map-pin mr-2"></i>My Addresses
                    </a>
                    ...
                    <a class="nav-link mb-2" id="v-pills-notifications-tab" data-toggle="pill" href="#v-pills-notifications" role="tab" aria-controls="v-pills-notifications" aria-selected="false">
                        <i class="feather icon-bell mr-2"></i>Notifications
                    </a>
                        ...
                        <div class="profilebox py-4 text-center">
                            ...
                            <div class="profilename">
                                ...
                                <p class="text-muted my-3">
                                    <a href="my-account.html"><i class="feather icon-edit-2 mr-2"></i>Edit Profile</a>
                                </p>
                            </div>
                            ...
                            <div class="card border m-b-30">
                                ...
                                <div class="card-footer">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-6">
                                            <h6 class="mb-0">
                                                <button class="btn btn-success-rgba font-16"><i class="feather icon-file mr-2"></i>Invoice</button>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="wallet-box">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6">
                                    <p class="mb-0">
                                        <button class="btn btn-success-rgba font-16"><i class="feather icon-plus mr-2"></i>Add Money</button>
                                    </p>
                                </div>
                            </div>
                        </div>
