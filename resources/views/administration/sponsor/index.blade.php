...
@section('page_title', __('All Sponsors'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('All Sponsors') }}</b>
@endsection


@section('breadcrumb')
    <li class="breadcrumb-item text-capitalize">{{ __('Sponsors') }}</li>
    <li class="breadcrumb-item text-capitalize active">{{ __('All Sponsors') }}</li>
@endsection


@section('breadcrumb_buttons')
    <a href="{{ route('administration.sponsor.create') }}" class="btn btn-outline-dark btn-outline-custom fw-bolder">
        <i class="feather icon-plus"></i>
        <b>Create New Sponsor</b>
    </a>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header">
                <h5 class="card-title">{{ __('All Sponsors') }}</h5>
            </div>
            <div class="card-body">
