                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="action-btn-group mr-3">
                                            ...
                                            <a href="{{ route('administration.sport.show', $sport) }}" class="btn btn-outline-info btn-outline-custom btn-sm" data-toggle="tooltip" data-placement="top" title="{{ __('View?') }}">
