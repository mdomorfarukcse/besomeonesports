...
@section('page_title', __('Show Role'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('Show Role') }}</b>
@endsection
...
@section('breadcrumb_buttons')
    <a href="{{ route('administration.role.edit', ['role' => $role]) }}" class="btn btn-outline-dark btn-outline-custom fw-bolder">
                        ...
                        <div class="col-md-12">
                            <div class="card border">
                                <div class="card-header bg-primary-rgba border-bottom">
                                    <h5 class="card-title text-primary mb-0">Role's Information</h5>
                                </div>
