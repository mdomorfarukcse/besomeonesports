...
@section('page_title', __('All Permission'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('All Permission') }}</b>
@endsection


@section('breadcrumb')
    <li class="breadcrumb-item text-capitalize">{{ __('Permission') }}</li>
    <li class="breadcrumb-item text-capitalize active">{{ __('All Permission') }}</li>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header">
                <h5 class="card-title">{{ __('All Permission') }}</h5>
            </div>
            <div class="card-body">
