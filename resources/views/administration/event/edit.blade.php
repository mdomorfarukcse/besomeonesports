                    ...
                    <div class="row">  
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" min="0" step="0.01" name="registration_fee" value="{{ $event->registration_fee }}" class="form-control @error('registration_fee') is-invalid @enderror" placeholder="99.99" required/>
