...
@section('page_title', __('All Event Registrations'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('All Event Registrations') }}</b>
@endsection


@section('breadcrumb')
    <li class="breadcrumb-item text-capitalize">{{ __('Events') }}</li>
    <li class="breadcrumb-item text-capitalize active">{{ __('All Event Registrations') }}</li>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header">
                <h5 class="card-title">{{ __('All Event Registrations') }}</h5>
            </div>
            <div class="card-body">
