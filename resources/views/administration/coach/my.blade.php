...
@section('page_title', __('My Coaches'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('My Coaches') }}</b>
@endsection


@section('breadcrumb')
    <li class="breadcrumb-item text-capitalize">{{ __('Coaches') }}</li>
    <li class="breadcrumb-item text-capitalize active">{{ __('My Coaches') }}</li>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header">
                <h5 class="card-title">{{ __('My Coaches') }}</h5>
            </div>
            <div class="card-body">
