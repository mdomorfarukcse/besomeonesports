                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="tel" name="contact_number" value="{{ $profile->player->contact_number }}" class="form-control @error('contact_number') is-invalid @enderror" placeholder="+1 (123) 456 -7890" required/>
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text" name="city" value="{{ $profile->player->city }}" class="form-control @error('city') is-invalid @enderror" placeholder="City" required/>
                                        @error('city')
                                            <b class="text-danger"><i class="feather icon-info mr-1"></i>{{ $message }}</b>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 form-group">
                                        ...
                                        <input type="text" name="state" value="{{ $profile->player->state }}" class="form-control @error('state') is-invalid @enderror" placeholder="State" required/>
                                        @error('state')
                                            <b class="text-danger"><i class="feather icon-info mr-1"></i>{{ $message }}</b>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <input type="number" min="0" step="0.01" name="height" value="{{ $profile->player->height }}" class="form-control @error('height') is-invalid @enderror" placeholder=""/>
                                        @error('height')
                                            <b class="text-danger"><i class="feather icon-info mr-1"></i>{{ $message }}</b>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 form-group">
                                        ...
                                        <input type="number" min="0" step="0.01" name="weight" value="{{ $profile->player->weight }}" class="form-control @error('weight') is-invalid @enderror" placeholder=""/>
                                        @error('weight')
                                            <b class="text-danger"><i class="feather icon-info mr-1"></i>{{ $message }}</b>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" name="street_address" value="{{ $profile->player->street_address }}" class="form-control @error('street_address') is-invalid @enderror" placeholder="123 Main Street" required/>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" name="extended_address" value="{{ $profile->player->extended_address }}" class="form-control @error('extended_address') is-invalid @enderror" placeholder="123 Main Street" required/>
