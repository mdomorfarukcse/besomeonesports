                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <select class="select2-single form-control @error('guardian_relation') is-invalid @enderror" name="guardian_relation" @role('guardian') required @endrole>
                                                ...
                                                <option value="Aunt" @selected($player->guardian_relation === 'Aunt')>Aunt</option>
                                            </select>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            ...
                                            <input type="text" name="street_address" value="{{ $player->street_address }}" class="form-control @error('street_address') is-invalid @enderror" placeholder="123 Main Street" required/>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" name="city" value="{{ $player->city }}" class="form-control @error('city') is-invalid @enderror" placeholder="City" required/>
                                            @error('city')
                                                <b class="text-danger"><i class="feather icon-info mr-1"></i>{{ $message }}</b>
                                            @enderror
                                        </div>
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" name="state" value="{{ $player->state }}" class="form-control @error('state') is-invalid @enderror" placeholder="State" required/>
                                            @error('state')
                                                <b class="text-danger"><i class="feather icon-info mr-1"></i>{{ $message }}</b>
                                            @enderror
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" name="guardian1_contact" value="{{ $player->guardian1_contact }}" class="form-control @error('guardian1_contact') is-invalid @enderror" placeholder="Ex: +1 (123) 456 -7890"/>
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" name="guardian2_contact" value="{{ $player->guardian2_contact }}" class="form-control @error('guardian2_contact') is-invalid @enderror" placeholder="Ex: +1 (123) 456 -7890"/>
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" name="guardian3_contact" value="{{ $player->guardian3_contact }}" class="form-control @error('guardian3_contact') is-invalid @enderror" placeholder="Ex: +1 (123) 456 -7890"/>
