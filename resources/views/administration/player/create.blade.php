                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <label for="guardian_relation">Relation With Player @role('guardian') <span class="required">*</span> @endrole</label>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="email" name="guardian2_email" value="{{ old('guardian2_email') }}" class="form-control @error('guardian2_email') is-invalid @enderror" placeholder="Ex: guardian@mail.com"/>
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="email" name="guardian3_email" value="{{ old('guardian3_email') }}" class="form-control @error('guardian3_email') is-invalid @enderror" placeholder="Ex: guardian@mail.com"/>
                                            ...
                                            <div class="card border m-b-10">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 form-group">
                                                            <label for="jersey_number">Request Jersey Number(Not Guaranteed)</label>
                                                            <input type="text" name="players[0][jersey_number]" value="{{ old('jersey_number') }}" class="form-control @error('jersey_number') is-invalid @enderror" placeholder="Jersey Number" maxlength="3"/>
                                                            @error('jersey_number')
                                                                <b class="text-danger"><i class="feather icon-info mr-1"></i>{{ $message }}</b>
                                                            @enderror
                                                        </div>
