...
@section('page_title', __('My Players'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('My Players') }}</b>
@endsection


@section('breadcrumb')
    <li class="breadcrumb-item text-capitalize">{{ __('Players') }}</li>
    <li class="breadcrumb-item text-capitalize active">{{ __('My Players') }}</li>
@endsection
            ...
            <div class="col-md-12">
                <div class="alert-list">
                    <div class="alert alert-success" role="alert">
                        ...
                        <p>Thank you for registering your child! Now it's time to assign your player to the league. Choose
                            the appropriate league for your child's age group and skill level, and get ready to join the
                            fun! Your child is one step closer to experiencing the joy of basketball.</p>
                        <hr>
                        <p class="mb-1 bold">Step 2: Add Your Player to the League. Checkout and Pay for Your Registration
                            <a href="{{ route('administration.league.index') }}" class="btn btn-theme btn-sm"> Register
                                League</a>
                        </p>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title">{{ __('My Players') }}</h5>
                </div>
                <div class="card-body">
                                                ...
                                                <div class="action-btn-group mr-3">
                                                    @if (auth()->user()->can('player.show'))
                                                        ...
                                                        <a href="{{ route('administration.player.show', ['player' => $player]) }}"
                                                            class="btn btn-outline-info btn-outline-custom btn-sm"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="{{ __('View?') }}">
                                                    ...
                                                    @if (auth()->user()->can('player.destroy'))
                                                        <a href="{{ route('administration.player.destroy', ['player' => $player]) }}"
                                                            class="btn btn-outline-danger btn-outline-custom btn-sm"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="{{ __('Delete?') }}"
