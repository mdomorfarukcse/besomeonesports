                    ...
                    <div class="row no-gutters align-items-center justify-content-center">
                        ...
                        <div class="col-md-8 col-lg-6">
                            <div class="text-center">
                                ...
                                <img src="{{ asset('assets/images/error/internal-server.svg') }}" class="img-fluid error-image" alt="404" />
                                <h4 class="error-subtitle mb-4">Internal Server Error</h4>
                                <p class="mb-4">Sorry Something Went Wrong. Please return to previous page or visit home page.</p>
