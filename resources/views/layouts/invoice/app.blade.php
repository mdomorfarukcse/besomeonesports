...
<html lang="en-US">
    <head>
        @include('layouts.invoice.partials.header')
    </head>
    <style>
        a:hover {
            ...
            <tr>
                <td>
                    <table style="background-color: #f2f3f8; max-width: 670px; margin: 0 auto;" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <a href="{{ config('app.url') }}" title="logo" target="_blank">
                                    <img width="150" src="{{ asset('assets/images/logo.png') }}" title="logo" alt="logo" />
                                </a>
                            </td>
                        </tr>
                        <tr>
                        ...
                        @include('layouts.invoice.partials.footer')
                    </table>
                </td>
            </tr>
        </table>
