            ...
            <div class="col-lg-5">
                <div class="logo-about mt-3 mt-lg-0 d-md-flex align-items-start justify-content-between">
                    <a href="#" class="col-lg-4">
                        <img src="{{ asset('frontend/images/logow.png') }}" alt="logo" />
                    </a>
                    <p class="col-lg-8 ms-md-4 mt-4 mt-md-0 text-white spt">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been</p>
                </div>
