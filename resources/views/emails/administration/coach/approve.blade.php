...
<div>
    ...
    <br>
    You have requested to become a Coach on <a href="{{ config('app.url') }}"><strong>{{ config('app.name') }}</strong></a>. We are glad to know you that, your request has been approved & you have been assigned as a Coach in <a href="{{ config('app.url') }}"><strong>{{ config('app.name') }}</strong></a>. 
    <br>
    Your login credential has been given below.
</div>
<br>
